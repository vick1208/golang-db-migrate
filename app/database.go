...
//migrate -database "mysql://root@tcp(localhost:3306)/golang_db_migration" -path db/migrations force 20230724051651
//migrate -database "mysql://root@tcp(localhost:3306)/golang_db_migration" -path db/migrations version
